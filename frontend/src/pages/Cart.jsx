...
const Cart = () => {
  const {products, currerncy ,cartItems,updateQuantity,navigate} = useContext(ShopContext);
                  ...
                  <div className='flex items-start gap-6'>
                    ...
                    <div>
                        ...
                        <div className='flex items-center gap-5 mt-2'>
                          <p>{currerncy}{productData.price}</p>
      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-end'>
            <button onClick={()=>navigate('/place-order')} className='bg-black text-white text-xs px-10 py-4'>PROCED TO CHECKOUT</button>
          </div>
        </div>
      </div>
